...
public class ReplicatedTests {
	...
	public void hasNonAlphaFirstName() {
		...
		assertTrue(errorMessages.contains("First name needs to be alpha characters only!"));
	}
	...
	public void hasNonAlphaLastName() {
		...
		assertTrue(errorMessages.contains("Last name needs to be alpha characters only!"));
	}
	...
	public void hasInvalidStartDate() {
		...
		assertTrue(errorMessages.contains("Start Date: 08/06/2021 must be in YYYY-MM-DD format!"));
	}
	...
	public void hasInvalidEndDate() {
		...
		assertTrue(errorMessages.contains("End Date: 08/06/2021 must be in YYYY-MM-DD format!"));
	}
	...
	public void hasEndDateBeforeStartDate() {
		...
		assertTrue(errorMessages.contains("Start date must be before end date!"));
	}
}
